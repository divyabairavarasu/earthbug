...
- Name: error-handling.spec.js >> Error Handling — Gemini API failures >> empty text response from Gemini shows parse error
- Location: tests/error-handling.spec.js:208:3
...
- generic [ref=e3]:
  ...
  - main [ref=e11]:
    - generic [ref=e12]:
      ...
      - paragraph [ref=e14]: "Failed to execute 'json' on 'Response': Unexpected end of JSON input"
