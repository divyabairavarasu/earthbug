...
- Name: api-key.spec.js >> API Key Entry >> shows the API key form on first load
- Location: tests/api-key.spec.js:15:3
...
Locator: getByRole('heading', { name: /connect to google gemini/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /connect to google gemini/i })
