...
- Name: production-features.spec.js >> Improved bug image alt text >> hero image alt is "Photo of <name>" when name is present
- Location: tests/production-features.spec.js:193:3
