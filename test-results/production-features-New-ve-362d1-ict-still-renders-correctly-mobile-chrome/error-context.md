...
- Name: production-features.spec.js >> New verdict types >> legacy Garden Bully verdict still renders correctly
- Location: tests/production-features.spec.js:88:3
...
Locator: getByRole('heading', { name: 'Japanese Beetle' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Japanese Beetle' })
