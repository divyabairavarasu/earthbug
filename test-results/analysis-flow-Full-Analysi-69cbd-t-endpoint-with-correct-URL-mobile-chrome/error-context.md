...
- Name: analysis-flow.spec.js >> Full Analysis Flow >> Gemini request hits the generateContent endpoint with correct URL
- Location: tests/analysis-flow.spec.js:68:3
...
Expected substring: "generateContent"
