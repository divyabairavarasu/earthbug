...
- Name: production-features.spec.js >> New verdict types >> Context-Dependent verdict renders 🤷 badge
- Location: tests/production-features.spec.js:73:3
...
Locator: getByRole('heading', { name: 'Ground Beetle' })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Ground Beetle' })
