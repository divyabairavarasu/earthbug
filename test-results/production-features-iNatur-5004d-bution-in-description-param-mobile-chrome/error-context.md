...
- Name: production-features.spec.js >> iNaturalist "Contribute to Science" card >> link includes EarthBug attribution in description param
- Location: tests/production-features.spec.js:165:3
