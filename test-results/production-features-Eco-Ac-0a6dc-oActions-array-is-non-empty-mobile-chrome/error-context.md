...
- Name: production-features.spec.js >> Eco-Actions "What You Can Do" >> section renders when ecoActions array is non-empty
- Location: tests/production-features.spec.js:118:3
