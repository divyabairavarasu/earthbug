...
- Name: security.spec.js >> Security — API key visibility >> API key input has autocomplete=off to prevent browser autofill
- Location: tests/security.spec.js:66:3
...
Locator: getByLabel(/gemini api key/i)
Expected: "off"
Timeout: 5000ms
