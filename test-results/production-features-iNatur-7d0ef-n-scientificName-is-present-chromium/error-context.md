...
- Name: production-features.spec.js >> iNaturalist "Contribute to Science" card >> card renders when scientificName is present
- Location: tests/production-features.spec.js:150:3
