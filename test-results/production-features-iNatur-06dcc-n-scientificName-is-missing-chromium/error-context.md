...
- Name: production-features.spec.js >> iNaturalist "Contribute to Science" card >> card absent when scientificName is missing
- Location: tests/production-features.spec.js:182:3
