...
- Name: api-key.spec.js >> API Key Entry >> "Get a free Gemini API key" link is present
- Location: tests/api-key.spec.js:96:3
...
Locator: getByRole('link', { name: /get a free gemini api key/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /get a free gemini api key/i })
