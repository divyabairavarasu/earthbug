...
- Name: error-handling.spec.js >> Error Handling — Gemini API failures >> network failure shows connection error message
- Location: tests/error-handling.spec.js:162:3
