...
- Name: production-features.spec.js >> iNaturalist "Contribute to Science" card >> link opens in new tab with safe rel attribute
- Location: tests/production-features.spec.js:174:3
