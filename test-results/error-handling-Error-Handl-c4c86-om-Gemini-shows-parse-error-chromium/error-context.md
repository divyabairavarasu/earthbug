...
- Name: error-handling.spec.js >> Error Handling — Gemini API failures >> malformed JSON from Gemini shows parse error
- Location: tests/error-handling.spec.js:183:3
